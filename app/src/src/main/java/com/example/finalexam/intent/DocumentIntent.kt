...
sealed class DocumentIntent {
    ...
    data class BookmarkDocument(val documentId: String, val userId: String) : DocumentIntent()
    data class UnbookmarkDocument(val documentId: String, val userId: String) : DocumentIntent()
}